        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10 lg:gap-12">
          {products.map((product) => (
            <div key={product.id} className="group">
              <div className="relative bg-neutral-900 rounded-3xl p-8 h-full hover:shadow-2xl transition-all duration-300 hover:-translate-y-2 border border-neutral-800">
                {/* Product Image */}
                <div className="relative mb-6 overflow-hidden rounded-2xl">
                  <div className="aspect-[4/3] bg-gradient-to-br from-neutral-800 to-neutral-700 flex items-center justify-center">
                    <div className="text-neutral-300 text-center">
                      <div className="w-16 h-16 mx-auto mb-3 bg-neutral-600 rounded-xl flex items-center justify-center">
                  ...
                  <div className="absolute inset-0 bg-black/50 opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-center justify-center rounded-2xl">
                    <div className="flex space-x-3">
                      <button className="px-4 py-2 bg-white text-neutral-900 rounded-full text-sm font-medium hover:bg-neutral-200 transition-colors duration-200">
                        View Details
                      </button>
                ...
                <div className="space-y-4">
                  <div className="inline-block px-3 py-1 bg-neutral-800 text-neutral-300 text-xs font-medium rounded-full">
                    {product.category}
                  </div>
                  
                  <h3 className="text-xl font-bold text-neutral-100 group-hover:text-neutral-300 transition-colors duration-300">
                    {product.name}
                  </h3>
                  ...
                  <div className="space-y-2">
                    ...
                    {product.features.length > 3 && (
                      <div className="flex items-center space-x-2">
                        ...
                        <span className="text-neutral-500 text-xs">+{product.features.length - 3} more features</span>
                      </div>
                    )}
                  </div>
                </div>
                ...
                {/* Hover indicator */}
                <div className="absolute bottom-4 right-4 w-8 h-8 bg-neutral-800 rounded-full opacity-0 group-hover:opacity-100 transition-all duration-300 flex items-center justify-center">
