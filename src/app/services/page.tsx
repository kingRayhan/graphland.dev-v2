    ...
    steps: [
      {
        ...
        body: "We analyze your requirements and create a detailed project roadmap.",
      },
      {
        name: "Design & Prototyping",
        body: "Creating wireframes and interactive prototypes for your approval.",
      },
      {
        name: "Development",
        body: "Building your website with modern technologies and best practices.",
      },
      {
        name: "Testing & Launch",
        body: "Thorough testing and deployment to production environment.",
      },
    ],
    faq: [
      {
      ...
      },
      {
        ...
        answer:
          "Yes, we offer comprehensive maintenance packages to keep your site updated and secure.",
      },
      {
    ...
    steps: [
      {
        ...
        body: "Define app goals, target audience, and technical requirements.",
      },
      {
        name: "UI/UX Design",
        body: "Create intuitive and engaging user interfaces and experiences.",
      },
      {
        name: "Development & Testing",
        body: "Build native or cross-platform apps with rigorous testing.",
      },
      {
        name: "Deployment & Support",
        body: "Launch on app stores and provide ongoing maintenance.",
      },
    ],
    faq: [
      {
        ...
        answer:
          "Yes, we develop native apps for both platforms as well as cross-platform solutions.",
      },
      {
        question: "How much does mobile app development cost?",
        answer:
          "Costs vary based on complexity. We provide detailed estimates after understanding your requirements.",
      },
      {
        question: "Can you help with app store submission?",
        answer:
          "Yes, we handle the entire app store submission process and optimization.",
      },
    ],
  },
  {
    ...
    steps: [
      {
        ...
        body: "Understanding your business needs and technical specifications.",
      },
      {
        name: "Architecture Design",
        body: "Planning the application structure and technology stack.",
      },
      {
        name: "Development",
        body: "Building robust desktop applications with modern frameworks.",
      },
      {
        name: "Distribution",
        body: "Packaging and distributing your application across platforms.",
      },
    ],
    faq: [
      {
        ...
        answer:
          "We develop for Windows, macOS, and Linux using cross-platform technologies.",
      },
      {
        question: "Can desktop apps integrate with web services?",
        answer:
          "Yes, we can integrate with APIs, databases, and cloud services seamlessly.",
      },
      {
        question: "Do you provide installation packages?",
        answer:
          "We create professional installers and handle code signing for security.",
      },
    ],
  },
];
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="text-center max-w-4xl mx-auto">
            ...
            <p className="text-xl md:text-2xl text-neutral-400 leading-relaxed mb-12">
              ...
              thrive in the modern world. From web development to mobile apps
                          ...
                          <div className="w-20 h-20 mx-auto mb-4 bg-neutral-600 rounded-2xl flex items-center justify-center">
                            ...
                            >
                              ...
                              {(service.title ?? "").includes("Desktop") && (
                                <path
                                  fillRule="evenodd"
                                  d="M3 4a1 1 0 011-1h12a1 1 0 011 1v8a1 1 0 01-1 1h-4l-1 2h2a1 1 0 110 2H7a1 1 0 110-2h2l-1-2H4a1 1 0 01-1-1V4zm13 1H4v6h12V5z"
                                  clipRule="evenodd"
                                />
                              )}
                            </svg>
              ...
              <div key={service._id}>
                ...
                <div className="grid grid-cols-1 gap-6 mb-12">
                  {service.faq?.map((item, index) => (
                    <div
                      key={index}
                      className="bg-neutral-900 border border-neutral-800 rounded-2xl p-6 shadow-sm hover:shadow-lg transition-shadow duration-200"
                    >
