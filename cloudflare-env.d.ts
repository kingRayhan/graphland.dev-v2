/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv cloudflare-env.d.ts` (hash: 43f45f600fd7a79ca2959b2e1c5291b3)
// Runtime types generated with workerd@1.20251217.0 2024-12-30 global_fetch_strictly_public,nodejs_compat
declare namespace Cloudflare {
	interface Env {
		NEXT_PUBLIC_GRAPHQL_API_URL: string;
		NEXT_INC_CACHE_R2_BUCKET: R2Bucket;
		WORKER_SELF_REFERENCE: Fetcher /* graphland-dev */;
